...
![Nuclear Energy Consumption in California](results/nuclear_california.png)  

- National Trends: Overall U.S. nuclear energy consumption.
![National Nuclear Energy Consumption Trends](results/nuegb_national.png)  

- Forecast Comparisons: Actual vs. predicted consumption using different models.
![Forecast vs Actual – Exponential Smoothing](results/nuegb_forecast_1960.png)  
![Forecast vs Actual – ARIMA](results/nuegb_auto_arima_forecast.png)  
![Forecast vs Actual – XGBoost vs Random Forest](results/nuegb_xgb_vs_rf_forecast.png) 
